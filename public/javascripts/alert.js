function alerterMsg(msg, mode) { //mode为空，即只有一个确认按钮，mode为1时有确认和取消两个按钮
    msg = msg || '';
    mode = mode || 0;
    ...
    alertBox.id = 'alerterMsg';
    alertBox.style.cssText = styleStr1;
    //创建弹出框里面的内容P标签
    var alerterMsg_info = document.createElement('P');
    alerterMsg_info.id = 'alerterMsg_info';
    alerterMsg_info.innerHTML = msg;
    alertBox.appendChild(alerterMsg_info);
    //创建按钮
    var btn1 = document.createElement('a');
    btn1.id = 'alerterMsg_btn1';
